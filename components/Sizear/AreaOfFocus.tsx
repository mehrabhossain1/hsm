...
const AreaOfFocus = () => {
  return (
    <div className="max-w-screen-xl mx-auto sm:px-6 lg:px-16 pt-16">
      ...
      <motion.div
        ...
        className="mt-6 bg-gray-50 shadow-lg rounded-lg p-8 border-l-4 border-green-500"
      >
        ...
        <p className="text-gray-600 leading-relaxed text-justify">
          ...
          service delivery, my work emphasizes public financial management, the
          role of the private sector, and human-centered design. These elements
          are critical for rethinking and formulating comprehensive urban health
          policies aimed at building sustainable and resilient health systems. I
          also engage in research to understand complex health sector challenges
          and generate evidence to support government initiatives through
          targeted advocacy.&quot;
        </p>
      </motion.div>
