  ...
  return (
    <div className=" bg-slate-50">
      <div className="max-w-screen-xl mx-auto sm:px-6 lg:px-16 py-16 my-16 ">
        ...
        <div>
          <h3 className="text-2xl md:text-2xl font-bold text-gray-600 pt-16 underline underline-offset-4">
            Career Profile/Professional Endeavors
          </h3>
          ...
          <p className="text-gray-700 leading-relaxed text-justify pt-4">
            ...
            (OD), an international organization based in the USA. In this role,
            he contributes to the USAID-funded global project, Health System for
            ...
            promoting evidence-based public health practices and knowledge at
            the national level.
          </p>
          <p className="text-gray-700 leading-relaxed text-justify pt-4">
            ...
            hands-on experience, has provided him with a deep understanding of
            the systemic causes of poor health, including poverty, low education
            levels, and inadequate political leadership.
          </p>
          <p className="text-gray-700 leading-relaxed text-justify pt-4">
            Sizear recognizes that health interventions alone are insufficient
            for sustainable change. As an advocate for health system, he engages
            in activism to promote public health. The Health Systems Matter
