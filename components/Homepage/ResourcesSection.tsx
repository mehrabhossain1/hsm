...
const Card: React.FC<CardProps> = ({ title, description, image, link }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 p-6 bg-[#001844] text-white transition-all duration-300 mr-6"
        style={{ height: hovered ? "12rem" : "8rem" }}
      >
  ...
  return (
    <section className="bg-gray-100 py-16 px-8">
      <div className="flex justify-between">
        <h2 className="text-2xl text-gray-600 mb-8 border-b border-gray-400 inline-block">
          RESOURCES & BOOKMARKS
        </h2>
