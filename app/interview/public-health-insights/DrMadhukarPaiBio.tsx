    ...
    <div className="max-w-screen-lg mx-auto px-6 py-12 relative">
      ...
      >
        <div className="py-6 font-medium">
          <p className="px-6 text-gray-700 mt-2 leading-relaxed text-justify">
      ...
      <div className="flex justify-center my-4 ">
        <button
          onClick={() => setIsExpanded(!isExpanded)}
          className="mt-4 bg-[#2D8CBB] text-white px-4 py-2 rounded-md hover:bg-[#1B6E99] transition duration-200"
        >
