...
const VisionAndMissionPage = () => {
    return (
        <div className="bg-gradient-to-r from-[#01CAC2]/10 via-white to-[#01CAC2]/10">
            ...
            <div className="min-h-screen max-w-screen-lg mx-auto px-16 flex flex-col items-center justify-start ">
                {/* Vision Section */}
                <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center gap-4">
                    ...
                    <div className="w-full md:w-1/2 space-y-6 text-gray-700 text-justify">
                        ...
                        <p>
                            ...
                            <strong>evidence-based platform</strong> that
                            empowers emerging public health professionals to
                            become{" "}
                            <strong>
                                informed and confident global health advocates,
                            </strong>{" "}
                ...
                <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row-reverse items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2 space-y-6 text-gray-700 text-justify">
                        ...
                        <p>
                            ...
                            <strong>
                                comprehensive, health system-focused resources
                            </strong>{" "}
                            from diverse organizations to{" "}
                            <strong>enhance the capabilities</strong> of public
                            health professionals and promote public health
                            issues. The platform offers significant news,
                            publications, and insights, both historical and
                            contemporary, covering a broad spectrum of topics
                ...
                <div className="max-w-screen-xl mx-auto flex flex-col  items-center gap-4">
                    ...
                    <div className="w-full md:w-1/2 space-y-6 text-gray-700 text-justify">
                        ...
                        <p>
                            ...
                            passionate and confident health systems advocates
                            who recognize the importance of robust health
