          ...
          <div className="space-y-6 order-2 lg:order-1 text-justify px-8">
            ...
            <div className="text-gray-700 leading-relaxed">
              <p>
                ...
                is my profession and passion, pursued by choice. I currently
                serve as a Technical Advisor for the{" "}
                <a
              ...
              <p className="mt-4">
                ...
                approaches and stronger health systems. To support this, I
                founded{" "}
                ...
                ) to promote and disseminate critical public health issues. I
                also write public health columns for national newspapers, blogs,
                and have published research in peer-reviewed journals.
